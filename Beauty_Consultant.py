...
import os
os.environ["OPENAI_API_KEY"] = "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"
...
if uploaded_file :
    ...
    loader = CSVLoader(file_path=tmp_file_path, encoding = 'unicode_escape') # encoding="utf-8"
    data = loader.load()
    ...
    chain = ConversationalRetrievalChain.from_llm(
        ...
        openai_api_key=api_key_input), retriever=vectors.as_retriever()
    )
